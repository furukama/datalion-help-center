...
_[Note: This cannot be changed later, so choose it carefully]._
...
![image-20240325-104338.png](/img/178094166.png)

The question variables (f1 - f6) are assigned the following labels and values:

<table data-table-width="760" data-layout="default" data-local-id="b7afefbe-1f3c-4921-86ad-1a002c76b210" class="confluenceTable"`>`<tbody><tr><td class="confluenceTd"`>`<p><strong>Frage</strong>`<`/p>`</td>`<td class="confluenceTd"`>`<p><strong>Label</strong>`<`/p>`</td>`<td class="confluenceTd"`>`<p><strong>Antwort (Wert)`<`/strong>`<`/p>`</td>`<td class="confluenceTd"`>`<p><strong>Antwort (Label)`<`/strong>`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f1</p>`</td>`<td class="confluenceTd"`>`<p>Nutzen Sie DataLion bereits in Ihrem Unternehmen?<br/`>`(Do you use DataLion in your company?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>1, 2</p>`</td>`<td class="confluenceTd"`>`<p>„DataLion Nutzer“ (user),<br/`>`„DataLion Nicht-Nutzer“ (non-user)`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f2_1</p>`</td>`<td class="confluenceTd"`>`<p>Würden Sie sich selbst als Experte in der Datenvisualisierung beschreiben?<br/`>`(Would you describe yourself as an expert in data visualization?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>0, 1</p>`</td>`<td class="confluenceTd"`>`<p>„Nein“ (no), „Ja“ (yes)`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f2_2</p>`</td>`<td class="confluenceTd"`>`<p>Haben Sie bereits Software zur Datenvisualisierung verwendet?<br/`>`(Have you already used data visualization software?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>0, 1</p>`</td>`<td class="confluenceTd"`>`<p>„Nein“ (no), „Ja“ (yes)`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f2_3</p>`</td>`<td class="confluenceTd"`>`<p>Möchten Sie sich in der Datenvisualisierung weiterbilden?<br/`>`(Would you like to learn more about data visualization?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>0, 1</p>`</td>`<td class="confluenceTd"`>`<p>„Ja!“ (yes), „Nicht wirklich” (not really)`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f3</p>`</td>`<td class="confluenceTd"`>`<p>Wie viele Punkte würden Sie sich selbst für Ihr Data know-how geben?<br/`>`(How many points would you give yourself for your data know-how?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>1 - 5</p>`</td>`<td class="confluenceTd"`>`<p>-`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f4_1</p>`</td>`<td class="confluenceTd"`>`<p>Wie gerne arbeiten Sie mit Daten?<br/`>`(How much do you like working with data?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>0 - 100</p>`</td>`<td class="confluenceTd"`>`<p>-`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f4_2</p>`</td>`<td class="confluenceTd"`>`<p>Wie gerne arbeiten Sie an Darstellungen von Daten?<br/`>`(How much do you enjoy working on data presentations?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>0 - 100</p>`</td>`<td class="confluenceTd"`>`<p>-`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f4_3</p>`</td>`<td class="confluenceTd"`>`<p>Wie viel Spaß bereitet Ihnen die Arbeit mit Ihrer bisherigen Software zur Datenvisualisierung?<br/`>`(How much do you enjoy working with your current data visualization software?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>0 - 100</p>`</td>`<td class="confluenceTd"`>`<p>-`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f5</p>`</td>`<td class="confluenceTd"`>`<p>Wie haben Sie von DataLion erfahren?<br/`>`(How did you hear about DataLion?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>Offene Nennung (open answer)`<`/p>`</td>`<td class="confluenceTd"`>`<p>-`<`/p>`</td>``</tr>`<tr><td class="confluenceTd"`>`<p>f6</p>`</td>`<td class="confluenceTd"`>`<p>Womit erstellen Sie professionelle Diagramme, Charts und Infografiken?<br/`>`(What do you use to create professional diagrams, charts and infographics?)`<`/p>`</td>`<td class="confluenceTd"`>`<p>Offene Nennung (open answer)`<`/p>`</td>`<td class="confluenceTd"`>`<p>-`<`/p>`</td>``</tr>``</tbody>``</table>
...
![image-20240325-104724.png](/img/178094154.png)
...
![image-20240325-111118.png](/img/178094103.png)
